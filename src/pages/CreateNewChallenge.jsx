...
<section className="create-new-challenge-section">
   ...
   <div className="tab current">
     ...
     <OutlinedCustomField  className="description-field" placeholder="Description"  >
        <textarea  placeholder=" " maxLength={200} rows={4} required={true}></textarea>
     </OutlinedCustomField>
 </div>
   <div className="tab next">
   <OutlinedCustomField className="title" placeholder="2">
        <input  type="text" placeholder=" "  required={true} />
     </OutlinedCustomField>
   </div>
   <div className="tab next">
   <OutlinedCustomField className="title" placeholder="3">
        <input  type="text" placeholder=" " required={true} />
     </OutlinedCustomField>
   </div>   
   </div>
